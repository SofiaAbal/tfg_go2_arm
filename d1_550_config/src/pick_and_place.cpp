    ...
    ***************************************************/
    {
        ...
        target_pose_msg.pose.position.y = 0.2;//misma pos lo muevo a un lado
        ...
        place_frame_transform.translation().x() = 0.1;  // Hook into attach_object_stage
