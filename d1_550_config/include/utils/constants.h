...
static constexpr const char* TABLE_LEG_FRONT_LEFT = "table_leg_front_left";
static constexpr const char* TABLE_LEG_FRONT_RIGHT = "table_leg_front_right";
static constexpr const char* TABLE_LEG_BACK_LEFT = "table_leg_back_left";
static constexpr const char* TABLE_LEG_BACK_RIGHT = "table_leg_back_right";
...
static constexpr const char* MOVE_TO_PUSH_STAGE = "move to push";
...
static constexpr const char* ALLOW_COLLISIONS_HAND_BUTTON_STAGE = "allow collision (hand,button)";
...
static constexpr const char* PUSH_OBJECT_CONTAINER = "push object";
